...
for (st in ST_to_plot) {
  ...
  barplot(bp, col=alpha("steelblue",0.5), border=NA, yaxt="n", cex.names = 1, las=1, col.axis="grey50", ylim=c(0,75))
#  x = unlist(par()["mfg"])[2]
  axis(2, col="grey50", col.axis="grey50", las=1, cex.axis=0.8)
...
Human cases $Y_{itl}$ of genotype $i$ at time $t$ in location $l$ are given by
$$
\begin{aligned}
...
- Key idea: split the probability of human case into
...
- Attribution in rural areas at a similar level pre and post poultry intervention.
